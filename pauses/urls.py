...
urlpatterns = [
    ...
    path('diary/<int:pk>/feelings/update/', PauseFeelingUpdateView.as_view(), name='update_feelings'),
    path('diary/<int:pk>/needs/update/', PauseNeedUpdateView.as_view(), name='update_needs'),
]